...
def chat_input_widget(key=None, pdf_data=None, pdf_filename="conversation.pdf", dark_mode=False, show_suggestions=False, suggestions=None):
    """
    ...
    Args:
        ...
        suggestions: List of strings for suggestion chips
